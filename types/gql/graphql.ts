...
export type GetTripShortsQuery = {
  __typename?: "Query";
  tripShorts?: Array<{
  ...
  page?: { __typename?: "wp_posts"; post_content?: string | null } | null;
};
...
export type GetParticipantsOnTripQuery = {
  __typename?: "Query";
  participantsOnTrip?: Array<{
    ...
    trip?: { __typename?: "wp_posts"; post_title: string } | null;
  } | null> | null;
};

export type GetTripsWithParticipantsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetTripsWithParticipantsQuery = {
  __typename?: "Query";
  tripsWithParticipants?: Array<{
    __typename?: "TripWithParticipants";
    id: number;
    trip_id?: number | null;
    report_date?: string | null;
    pptCount?: string | null;
...
export type GetTripDetailedListQuery = {
  __typename?: "Query";
  tripsCount?: number | null;
  tripsDetailList?: Array<{
...
export const GetTripShortsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetTripShorts" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "tripShorts" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "limit" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "post_name" } },
                { kind: "Field", name: { kind: "Name", value: "post_title" } },
                { kind: "Field", name: { kind: "Name", value: "thumb_url" } },
                { kind: "Field", name: { kind: "Name", value: "post_date" } },
              ],
            },
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "post_content" },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<GetTripShortsQuery, GetTripShortsQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "wp_postmeta" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "meta_value" },
                      },
                    ],
                  },
                },
          ...
          { kind: "Field", name: { kind: "Name", value: "tripsCount" } },
...
export const GetParticipantsOnTripDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "participantsOnTrip" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "report_date" } },
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "post_title" },
                      },
                    ],
                  },
                },
  ...
  GetParticipantsOnTripQuery,
  GetParticipantsOnTripQueryVariables
>;
export const GetTripsWithParticipantsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetTripsWithParticipants" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "tripsWithParticipants" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "trip_id" } },
                { kind: "Field", name: { kind: "Name", value: "report_date" } },
                { kind: "Field", name: { kind: "Name", value: "pptCount" } },
                { kind: "Field", name: { kind: "Name", value: "post_title" } },
  ...
  GetTripsWithParticipantsQuery,
  GetTripsWithParticipantsQueryVariables
>;
export const GetTripDetailedListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetTripDetailedList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "tripsDetailList" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "location" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "category_names" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "category_slugs" },
                },
                { kind: "Field", name: { kind: "Name", value: "thumb_url" } },
              ],
            },
  ...
  GetTripDetailedListQuery,
  GetTripDetailedListQueryVariables
>;
